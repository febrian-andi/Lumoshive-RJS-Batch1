  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description:
          "Todo List Application is a user-friendly tool designed to help you stay organized and productive. It offers full CRUD functionality, allowing you to create, read, update, and delete tasks effortlessly. Additionally, the app includes a feature to mark tasks as complete, enabling you to track your progress and stay on top of your goals.",
        theme_color: "#0d6efd",
        icons: [
          {
